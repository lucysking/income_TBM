...
RAWDIREC=/ifs/loni/faculty/thompson/four_d/Emily/Gotlib/ELS
#Pretest
DIREC=/ifs/loni/faculty/thompson/four_d/Emily/Gotlib/ELS/TBM_Xue

mkdir -p ${DIREC}/linear_reg_flirt/
mkdir -p ${DIREC}/linear_reg_flirt/${subj}

#This is the ICBM brain template
TMPL=/ifs/loni/faculty/thompson/four_d/Emily/Gotlib/ELS/076_template.nii.gz
